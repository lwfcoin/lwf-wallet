...
angular.module('liskApp').controller('voteController', ["oxyAPI", "$scope", "voteModal", "$http", "userService", "feeService", "$timeout", function (oxyAPI, $scope, voteModal, $http, userService, feeService, $timeout) {
