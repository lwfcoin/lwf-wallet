...
angular.module('liskApp').controller('passphraseController', ['dposOffline', 'oxyAPI', '$scope', '$rootScope', '$http', "$state", "userService", "newUser", 'gettextCatalog', '$cookies',
  function (dposOffline, oxyAPI, $rootScope, $scope, $http, $state, userService, newUser, gettextCatalog, $cookies) {
    userService.setData();
